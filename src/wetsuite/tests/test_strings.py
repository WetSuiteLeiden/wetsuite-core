...
from wetsuite.helpers.strings import is_numeric, is_mainly_numeric, has_text, count_unicode_categories, remove_diacritics
from wetsuite.helpers.strings import interpret_ordinal_nl, ordinal_nl,  simple_tokenize, simplify_whitespace
...
def test_count_unicode_categories_2():
    ...
    simpler, longer = count_unicode_categories( '\x02 \uE123 \u0065\u0301', nfc_first=False )
