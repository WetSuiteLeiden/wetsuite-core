...
def test_valid():
    ...
    assert (
        resolve("/akn/nl/act/gemeente/2024/CVDR696162")
        == "https://lokaleregelgeving.overheid.nl/CVDR696162/1"
    )
...
def test_invalid1():
    ...
    with pytest.raises(ValueError):
        resolve(
            "/nl/act/gemeente/2024/CVDR696162"
        )  # valid if it had /akn in front of it
